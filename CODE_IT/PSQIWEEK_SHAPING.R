# SHAPING SCRIPT FOR PSQI (WEEK VERSION)
...
library(readr)
S1_PSQI_week <- read_csv("Desktop/data_exp_16095_IT/S1_PSQI-week.csv")
View(S1_PSQI_week)
...
colnames(PSQI_W)
PSQI_W <- PSQI_W[, c(1,2,46,3,4,47,48,6,8,9,12,14,16,18,20,22,24,27,30,31,33,35)]
...
# Save the CSV, ripassare a mano la due e lasciarla Sleep2

write_csv(PSQI_W,"~/Desktop/data_exp_16095_IT/Scored File IT//PSQIb_SHAPED_IT.csv")
