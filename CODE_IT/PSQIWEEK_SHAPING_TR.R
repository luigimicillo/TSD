...
library(readr)
S1_PSQI_week <- read_csv("Desktop/data_exp_16095_IT/RAW OTHER/data_exp_16144_TR/S1_PSQI-week.csv")
View(S1_PSQI_week)

# Shaping the Dataset:

PSQI<- select(S1_PSQI_week,"Local Date", `Participant Private ID`,`Schedule ID`,
...
PSQI<- rename(PSQI, "PSQI_W_DAY" = "Local Date")
...
# I did not order the dataset because I don't know what it means
...
write_csv(PSQI,"/Users/luigimicillo/Desktop/data_exp_16095_IT/Scored\ Files\ Other/TR//PSQIb_TR.csv")
