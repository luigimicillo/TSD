# SHAPING THE MUNICH FOR DE

# 

#import
library(readr)
S1_MCQT <- read_csv("Desktop/data_exp_16095_IT/RAW OTHER/data_exp_15575_DE/S1_MCQT.csv")
View(S1_MCQT)
...
write_csv(muMCTQ, "/Users/luigimicillo/Desktop/data_exp_16095_IT/Scored\ Files\ Other/DE//muMCTQ_SHAPED_DE.csv")
