...
library(readr)
S1_ZITP <- read_csv("Desktop/data_exp_16095_IT/RAW OTHER/data_exp_16144_TR/S1_ZITP.csv")
View(S1_ZITP)
...
write_csv(Zitp_shaped,"/Users/luigimicillo/Desktop/data_exp_16095_IT/Scored\ Files\ Other/TR//ZITP_SCORED_TR.csv")
