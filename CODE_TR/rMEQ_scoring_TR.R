...
library(readr)
S1_rMEQ <- read_csv("Desktop/data_exp_16095_IT/RAW OTHER/data_exp_16144_TR/S1_rMEQ.csv")
View(S1_rMEQ)
...
write_csv(rMEQ,"/Users/luigimicillo/Desktop/data_exp_16095_IT/Scored\ Files\ Other/TR//rMEQ_SCORED_TR.csv")
