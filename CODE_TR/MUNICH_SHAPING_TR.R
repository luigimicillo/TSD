...
library(readr)
S1_MCQT <- read_csv("Desktop/data_exp_16095_IT/RAW OTHER/data_exp_16144_TR/S1_MCQT.csv")
View(S1_MCQT)
...
write_csv(muMCTQ,"/Users/luigimicillo/Desktop/data_exp_16095_IT/Scored\ Files\ Other/TR//muMCTQ_SHAPED_TR.csv")
