...
library(readr)
S1_PSQI <- read_csv("Desktop/data_exp_16095_IT/RAW OTHER/data_exp_15096-16303_FR/S1_PSQI.csv")
View(S1_PSQI)
...
write_csv(PSQI, "/Users/luigimicillo/Desktop/data_exp_16095_IT/Scored\ Files\ Other/FR//PSQIa_shaped_FR.csv")
