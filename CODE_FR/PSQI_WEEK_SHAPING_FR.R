...
library(readr)
S1_PSQI_week <- read_csv("Desktop/data_exp_16095_IT/RAW OTHER/data_exp_15096-16303_FR/S1_PSQI-week.csv")
View(S1_PSQI_weeek)

PSQI<- select(S1_PSQI_week,"Local Date", `Participant Private ID`,
...
# renaming the variables we will need (manca 5j)

PSQI <- rename(PSQI, "Sleep1" = "PSQI_1", "Sleep2" = "PSQI_2", "Sleep3" = "PSQI_3", "Sleep4" = "PSQI_4", "Sleep5a" = "PSQI_5a-quantised",
               ...
               "Sleep6" = "PSQI_7-quantised","Sleep7" = "PSQI_8-quantised", "Sleep8" = "PSQI_9-quantised",
               "Sleep9" = "PSQI_6-quantised")

# save the csv

write_csv(PSQI, "/Users/luigimicillo/Desktop/data_exp_16095_IT/Scored\ Files\ Other/FR//PSQIb_shaped_FR.csv")
