# SHAPING THE DEMOGRAPHICS OF THE FRENCH SAMPLE
...
library(readr)
S1_Demographics <- read_csv("Desktop/data_exp_16095_IT/RAW OTHER/data_exp_15096-16303_FR/S1_Demographics.csv")
...
Demographics <- select(Demographics, -"sex", -"Handedness", -"family", -"friends", -"colleagues", -"drug", -"covidsymptoms", -"covid", - "Homework")
...
write_csv(Demographics, "/Users/luigimicillo/Desktop/data_exp_16095_IT/Scored\ Files\ Other/FR//Demographics_shaped_FR.csv")
